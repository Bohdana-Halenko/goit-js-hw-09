...
// Дополнительный импор библиотеки уведомлений
...
// отсчитываемое время
let countDown = null;
// разница между текущим и отсчитываемым (секундомер)
let difference = 0;
...
flatpickr(dataTimeInputEl, {
  ...
  onClose(selectedDates) {
    ...
    //   если выбраная дата уже прошла, то кнопка старт не активна, выводим уведомление о ошибке
